...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      ["Popcorn Chicken", "பாப்கார்ன் சிக்கன்", 120],
      ["Veg Sandwich", "வெஜ் சாண்ட்விச்", 50],
  ...
  },
  {
    ...
    items: [
      ["Tea", "டீ", 20],
      ["Masala Tea", "மசாலா டீ", 25],
      ["Ginger Tea", "இஞ்சி டீ", 25],
  ...
  },
  {
    ...
    station: "Beverages",
    items: [
      ["Coffeemia Signature Tea", "காஃபீமியா சிக்னேச்சர் டீ", 25],
      ["Elachi Tea", "ஏலக்காய் டீ", 25],
      ["Chocolate Tea", "சாக்லேட் டீ", 25],
      ["Classic Black Tea", "கிளாசிக் பிளாக் டீ", 25],
    ],
  },
  {
    name: "Coffee",
    ...
    items: [
      ...
      ["Cappuccino / Latte", "கபுச்சினோ / லாட்டே", 25],
      ["Hot Chocolate / Boost", "பூஸ்ட்", 30],
      ["Coffeemia Special Iced Cappuccino", "காஃபீமியா ஸ்பெஷல் ஐஸ்டு கபுச்சினோ", 30],
      ["Cold Coffee", "கோல்ட் காபி", 50],
    ],
  },
  {
    // Packing is rung up like any other item, so it lands on the bill and in
    // the sales figures without a special rule anywhere in the pricing.
    name: "Parcel",
    local: "பார்சல்",
    station: "Beverages",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      ["Seasonal Fruit Juice", "பழச்சாறு", 60],
      ["Milkshakes", "மில்க்ஷேக்", 70],
      ["Rose Milk", "ரோஸ் மில்க்", 50],
    ],
  },
];
