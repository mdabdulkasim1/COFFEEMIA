...
const DEFAULT_SETTINGS = {
  ...
  // Parcel and takeaway bills carry a packing charge. The counter may raise it
  // for a big order but can never go under the floor — that is enforced on the
  // server, not just in the browser.
  parcelChargeEnabled: true,
  parcelChargeMin: 5,
  parcelChargeDefault: 5,
  parcelChargeLabel: "Parcel charge",
